...
var css$4, Develop, css$3, Social, css$2, Core, css$12, Selfhosted, css6, Routes;
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
	...
	<div class="${"flex m-1"}"><img alt="${"github logo"}" src="${"https://simpleicons.org/icons/kofi.svg"}" class="${"svelte-tq6odt"}">
		<a href="${"https://ko-fi.com/danielokita"}" class="${"svelte-tq6odt"}">Kofi</a></div>
</div>`;
    });
    css$3 = {
    ...
    Selfhosted = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$12);
      return `<div class="${"p-5 my-4 flex flex-wrap main flex-col svelte-x6n74l"}"><h1 class="${"text-center text-2xl text-nosferatu-100 my-2"}">Home Server</h1>
...
var css$5, Lib, css$42, Langs, css$32, UI, Simpleicons, css$22, Icons, css$13, Server2, css8, Dev;
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    css9 = ["assets/pages/dev.svelte-508e8ebc.css", "assets/searchbar-b9dc33c5.css"];
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    css11 = ["assets/pages/focus.svelte-27da02b0.css"];
  }
});
...
var css$43, School, css$33, Languages, css$23, Stem, css$14, Inso, css12, School_1;
...
var manifest = {
  ...
  _: {
    entry: { "file": "start-c1f5bac3.js", "js": ["start-c1f5bac3.js", "chunks/index-fee3d784.js"], "css": [] },
    nodes: [
