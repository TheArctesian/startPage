<script lang="ts">
  ...
  import MultiTimerPanel from './multi-timer-panel.svelte';
  import TimerHistoryModal from './timer-history-modal.svelte';
  import ManualTimeEntryModal from './manual-time-entry-modal.svelte';
  import NotificationSettingsModal from './notification-settings-modal.svelte';
